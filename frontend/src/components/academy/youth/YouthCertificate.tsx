    ...
    <section data-testid="youth-certificate-section" className="bg-[#fbfafa] py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          description={t(
            "Day 3 concludes with a graduation ceremony where every student receives a Rupantaram Certificate of Completion.",
            "तिसऱ्या दिवशी पदवी समारंभ होतो — प्रत्येक विद्यार्थ्याला रूपांतरम् पूर्णता प्रमाणपत्र मिळते."
          )}
          align="center"
        />
        ...
        <Reveal delay={0.15}>
          <div className="relative mx-auto mt-14 max-w-2xl">
            ...
            <div
              data-testid="youth-certificate-mockup"
